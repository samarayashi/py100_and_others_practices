...
class FlightSearch:
    ...
    def flight_check(self, origin_city_code, destination_city_code, from_time, to_time):
        ...
        try:
            ...
            try:
                # if there is not direct flight, try to find one stop flight
                ...
                print("There is no direct/one stop flight！")
                return None
            else:
                pprint(data)
            ...
            print(f"{flight_data.destination_city}: NTD{flight_data.price}")
            return flight_data
